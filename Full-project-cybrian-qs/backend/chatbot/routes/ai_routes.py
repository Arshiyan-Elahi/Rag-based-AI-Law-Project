...
from app.services.chat_query_persistence import persist_chat_query_exchange
from app.services.nlp.prompt_injector import get_style_prompt_injection
from app.services.nlp.editor_action_nlp import (
    build_nlp_bundle_for_action,
    log_nlp_detected,
    nlp_action_summary,
)
from app.services.profile_detection_store import (
    load_active_profile_detection_row,
    persist_profile_detection_for_sop_version,
    serialize_profile_detection_row,
)
from app.services.sop_version_metadata_compact import (
...
def _get_smart_rag_chain() -> Any:
    ...
    with _smart_rag_lock:
        ...
        try:
            from app.services.rag_cache import register_rag_chain
