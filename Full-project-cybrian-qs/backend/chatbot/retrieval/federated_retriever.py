...
class NoopReranker:
    """Fallback reranker that preserves retrieval order."""

    def rerank_top_n(self, _query: str, docs: List[Document], top_n: int) -> List[Document]:
        return (docs or [])[:max(0, int(top_n))]
