...
export const translations = {
    en: {
        ...
        showMetadataPanel: 'Show metadata',
        hideMetadataPanel: 'Hide metadata',
        ...
        category: 'Category',
        sopVersion: 'Document revision',
        department: 'Department',
        metadataOptionalPlaceholder: '',
        metadataDocTypeBadge: 'SOP',
        author: 'Author',
        reviewer: 'Reviewer',
    ...
    de: {
        ...
        referenceManagement: 'Referenzverwaltung',
        workflowAction: 'Workflow-Aktion',
        lifecycle: 'Lebenszyklus',
        changeLog: 'Änderungsprotokoll',
        noReferencesAdded: 'Keine Referenzen hinzugefügt.',
        showMetadataPanel: 'Metadaten anzeigen',
        hideMetadataPanel: 'Metadaten ausblenden',
